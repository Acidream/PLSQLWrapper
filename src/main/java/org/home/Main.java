...
public class Main {
    ...
    //Settings.generateSettingsExample();
      ...
      //  System.out.println(Settings.get().getGroups().get(0).getServiceFolder());
        ...
        System.out.println("------------------");
        Pkg pkg=DBReader.getPkg("ABS","EMP_ACTIONS");
    ...
    public static String genServiceFromPackage(Pkg pkg) throws FileNotFoundException {
        StringTemplateGroup stg = new StringTemplateGroup( new FileReader("E:\\projects\\PLSQLWrapper\\target\\classes\\Service.stg") ,DefaultTemplateLexer.class);
    ...
    public static String genServiceFromMethodList(List<Method> mlist) throws FileNotFoundException {
        StringTemplateGroup stg = new StringTemplateGroup( new FileReader("E:\\projects\\PLSQLWrapper\\target\\classes\\Methods.stg") ,DefaultTemplateLexer.class);
    ...
    public static String genEntityFromType(TableType inpTableType) throws FileNotFoundException {
        StringTemplateGroup stg = new StringTemplateGroup( new FileReader("E:\\projects\\PLSQLWrapper\\target\\classes\\Entity.stg") ,DefaultTemplateLexer.class);
